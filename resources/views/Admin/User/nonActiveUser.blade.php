        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="show-hide-col-nonActiveUser" class="table dt-table-hover" style="width:100%">
                                ...
                                <td class="text-center">
                                    <div class="action-btns">
                                        ...
                                        <a type="button" class="action-btn btn-delete bs-tooltip" data-toggle="tooltip"
                                            data-placement="top" title="استرجاع الطالب">
                                            <svg fill="#ce6f6f" viewBox="0 0 64 64" version="1.1"
...
@section('script')
    ...
    <script src="{{ asset('AdminAssets/plugins/src/table/datatable/custom_miscellaneous_nonActiveUser.js') }}"></script>
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener("click", function() {
                Swal.fire({
                    title: "هل أنت متأكد من استرجاع الطالب محمد مهنا؟",
                    text: "باسترجاعه سيتم إدخاله على الملتقى من جديد",
                    icon: "warning",
                    showCancelButton: true,
        ...
        // const rows = document.querySelectorAll('#show-hide-col-nonActiveUser tbody tr');
        ...
        // مفصولين ذكور | إناث | كل
        const sidebarItems = document.querySelectorAll('.nonactiveUserData');
        const rows = document.querySelectorAll('#show-hide-col-nonActiveUser tbody tr');
        // أضف حدث النقر على كل عنصر في الشريط الجانبي
        sidebarItems.forEach(item => {
            item.addEventListener('click', function() {
