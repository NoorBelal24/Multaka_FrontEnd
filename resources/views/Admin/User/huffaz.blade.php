        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="show-hide-col-huffaz" class="table dt-table-hover" style="width:100%">
...
@section('script')
    ...
    <script src="{{ asset('AdminAssets/plugins/src/table/datatable/custom_miscellaneous_huffaz.js') }}"></script>
