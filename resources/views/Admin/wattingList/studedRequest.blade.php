...
@section('content')
                ...
                <div class="widget-content widget-content-area">
                    <table id="show-hide-col-wattingList" class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr class="activeUser hafezFemale studyRequestFemale">
                                <td>
                                    <div class="media">
    ...
    <!-- Modal for Editing with Modern Design -->
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content shadow-lg rounded-3 editModal">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="editModalLabel">تعديل بيانات الطالب</h5>
                ...
                <div class="modal-body container">
                    <form id="editForm" class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label for="fullName" class="form-label label-color ">الاسم الرباعي</label>
                            <input type="text" class="form-control rounded-pill shadow-sm" id="fullName"
                                placeholder="  الاسم الرباعي">
                        </div>
                        <div class="col-md-4">
                            <label for="gender" class="form-label label-color ">الجنس</label>
    ...
    {{--     pop add request --}}
    <div class="modal fade" id="addHafez" tabindex="-1" role="dialog" aria-labelledby="addHafez"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content shadow-lg rounded-3 addHafez">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="addHafez"> إضافة طالب جديد </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <br>
                <div class="modal-body container">
                    <form id="editForm" class="row g-3 ">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="fullName" class="form-label label-color"> يرجى اختيار المشرف </label>
                            </div>

                            <div class="col-md-4">
                                <select class="form-select custom-select rounded-pill shadow-sm p-3 optionMushref"
                                    id="gender">
                                    <option value="" disabled selected>أسامة مهنا</option>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    <button type="button" class="btn btn-danger rounded-pill px-4"
                        data-bs-dismiss="modal">إغلاق</button>
                    <button type="button" class="btn btn-saveAddHafez rounded-pill px-4" id="saveAddHafez"> إضافة الطالب
...
@section('script')
    ...
    <script>
        ...
        // حفاظ ذكور | إناث | كل
        const sidebarItems = document.querySelectorAll('.studyRequestData');
