...
@section('content')
                        ...
                        <table class="table tableTathbeet table-bordered table-borderedMushref containe">
                            ...
                            <tbody>
                                <tr class="tathbeetRow">
                                    ...
                                    <td class="text-center">
                                        <button onclick="toggleVisibility('tathbeet1')"
                                            ...
                                            مشرفو الدورة وطلابها</button>

                                        <button
                                            class="btn-addMushrefTathbeet btn btn-outline-success btn-rounded mb-2 me-4 _effect--ripple waves-effect waves-light mx-4">
                                            <?xml version="1.0" ?>
                                            <!DOCTYPE svg
                                                PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'>
                                            <svg enable-background="new 0 0 91 91" height="91px" id="Layer_1"
                                ...
                                <tr id="tathbeet1" class="hidden">
                                    <td colspan="2">
                                        @include('Admin.MushrfeenTathbeet.student1')
                                    </td>
                                </tr>
                                ...
                                <tr id="tathbeet2" class="hidden">
                                    <td colspan="2">
                                        @include('Admin.MushrfeenTathbeet.student2')
                                    </td>
                                ...
                                <tr class="tathbeetRow">
                                    ...
                                    <td class="text-center">
                                        <button onclick="toggleVisibility('tathbeet3')"
                                            class=" tathbeetTitel btn btn-dark btn-rounded btn-outline-dark mb-2 me-4 _effect--ripple waves-effect waves-light">عرض
                                            مشرفو الدورة وطلابها</button>
                                        <button
                                            class="btn-addMushrefTathbeet btn btn-outline-success btn-rounded mb-2 me-4 _effect--ripple waves-effect waves-light mx-4">
                                ...
                                <tr id="tathbeet3" class="hidden">
                                    <td colspan="2">
                                        @include('Admin.MushrfeenTathbeet.student3')
                                    </td>
    ...
    @include('Admin.MushrfeenTathbeet.popUp.editMushrefThbeet')

    <!-- pop up add mushref    -->
    @include('Admin.MushrfeenTathbeet.popUp.addMushref')

    <!-- pop up add student    -->
    @include('Admin.MushrfeenTathbeet.popUp.addStudent')

    <!-- pop up add Dawra    -->
    @include('Admin.MushrfeenTathbeet.popUp.addDawra')
