...
<div class="modal fade" id="addMushrefTathbeet" tabindex="-1" role="dialog" aria-labelledby="addMushrefTathbeet"
aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content shadow-lg  addMushrefTathbeet signPop">

        <div class="popEditHeader text-white">
            <h5 class="mx-auto text-center">إضافة مشرف جديد </h5>
        ...
        <div class="modal-body container bodyEdit p-5">
            <form id="editForm" class="row g-3 text-center">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label for="fullName" class="form-label labelEdit-colorlable-add"> اختر مشرف جديد </label>
                    </div>
