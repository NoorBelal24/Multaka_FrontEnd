...
{{-- pop up edit --}}
<div class="modal fade" id="editCertificate" tabindex="-1" role="dialog" aria-labelledby="editCertificate"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content shadow-lg addCertificate signPop">

            <div class="popEditHeader text-white">
                <h5 class="mx-auto text-center" id="addDawra">تعديل شهادة جديدة </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <br>
            <div class="modal-body container bodyEdit">
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-saveEditCertificate rounded-pill px-4"
                    id="saveEditCertificate"> تعديل
                </button>
            </div>
        </div>
    </div>
